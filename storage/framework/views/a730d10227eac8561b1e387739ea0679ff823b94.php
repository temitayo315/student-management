...
<div class="container">
    <div class="row" style="position: relative; float: left;left: 400px">
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">Edit Record</h3>
                </div>
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="post" action="<?php echo e('/update/'.$student->id); ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php echo e(Request::old('cne')?:$student->cne); ?>" name="cne">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="location">Age:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control"  value="<?php echo e(Request::old('age')?:$student->age); ?>" name="age">
                </div>
            </div>
            <div class="form-group">
